...
Estudiar y comprender los incendios forestales de la Patagonia Andina por medio de datos derivados de instrumentos de teledetección y preprocesados con modelos robustos de consolidación.
...
\begin{itemize}
    ...
    \item Realizar la limpieza y procesamiento de los datos recopilados para su consolidación.
    ...
    \item Implementar modelos de Machine Learning que permitan predecir la probabilidad de nuevos focos en una región específica.
